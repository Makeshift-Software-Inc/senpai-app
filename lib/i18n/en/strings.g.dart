...
/// Strings: 7
///
/// Built on 2024-02-05 at 08:13 UTC
...
class _StringsErrorsEn {
  ...
  // Translations
  late final _StringsErrorsCreateUserEn create_user =
      _StringsErrorsCreateUserEn._(_root);
...
class _StringsErrorsOthersEn {
  ...
  String get something_went_wrong =>
      'Something went wrong and data couldn\'t loaded.';
...
extension on _StringsEn {
  dynamic _flatMapFunction(String path) {
    switch (path) {
      case 'errors.create_user.something_went_wrong':
        return 'Something went wrong, please try again later';
      case 'errors.others.no_item_found':
        return 'There is no data to show.';
      case 'errors.others.something_went_wrong':
        return 'Something went wrong and data couldn\'t loaded.';
      case 'errors.others.an_unknown_error':
        return 'An unknown error happened.';
      case 'errors.others.no_internet_connection':
        return 'Internet connectivity is not available.';
      case 'errors.others.server_failure':
        return 'Server failure encountered.';
      case 'errors.others.communication_error':
        return 'There was an error with our communication with the servers.';
      default:
        return null;
    }
  }
