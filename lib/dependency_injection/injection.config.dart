...
import 'package:fresh_dio/fresh_dio.dart' as _i44;
...
import 'package:senpai/core/auth/blocs/resend_verification_code_bloc.dart'
    as _i35;
import 'package:senpai/core/auth/blocs/sign_in_bloc.dart' as _i38;
import 'package:senpai/core/auth/blocs/validate_phone_bloc.dart' as _i56;
...
import 'package:senpai/core/avatar_shop/blocs/mark_avatar_as_default_bloc.dart'
    as _i31;
import 'package:senpai/core/chat/blocs/send_message_bloc.dart' as _i36;
...
import 'package:senpai/core/feed/blocs/undo_like_user_bloc.dart' as _i51;
...
import 'package:senpai/core/profile_fill/api/spotify/spotify_profile_info_api.dart'
    as _i41;
import 'package:senpai/core/profile_fill/api/universities_api.dart' as _i52;
...
import 'package:senpai/core/profile_fill/set_user_location/set_user_location_bloc.dart'
    as _i37;
import 'package:senpai/core/secure_storage/device_token_storage.dart' as _i50;
import 'package:senpai/core/secure_storage/secure_auth_storage.dart' as _i48;
...
import 'package:senpai/core/user/blocs/report_user/report_user_bloc.dart'
    as _i34;
import 'package:senpai/core/user/blocs/unmatch_user/unmatch_bloc.dart' as _i53;
...
import 'package:senpai/core/user/blocs/verify_request_user/fetch_verify_requests.dart'
    as _i20;
import 'package:senpai/dependency_injection/dio_client_di.dart' as _i65;
import 'package:senpai/dependency_injection/graphql_client_di.dart' as _i62;
import 'package:senpai/dependency_injection/network_info_di.dart' as _i63;
import 'package:senpai/dependency_injection/router_di.dart' as _i59;
import 'package:senpai/dependency_injection/secure_storage_di.dart' as _i60;
import 'package:senpai/dependency_injection/spotify_module_di.dart' as _i64;
import 'package:senpai/dependency_injection/university_module_di.dart' as _i61;
...
import 'package:senpai/models/auth/auth_model.dart' as _i47;
import 'package:senpai/models/auth/device_token_model.dart' as _i49;
import 'package:senpai/models/env_model.dart' as _i14;
import 'package:senpai/models/spotify_auth/spotify_auth_model.dart' as _i45;
import 'package:senpai/models/theme_model.dart' as _i43;
...
// initializes the registration of main-scope dependencies inside of GetIt
  Future<_i1.GetIt> init({
    ...
    gh.factory<_i31.MarkAvatarAsDefaultBloc>(
        () => _i31.MarkAvatarAsDefaultBloc());
    gh.factory<_i32.RemoveDeviceTokenBloc>(() => _i32.RemoveDeviceTokenBloc());
    gh.factory<_i33.ReorderPhotosBloc>(() => _i33.ReorderPhotosBloc());
    gh.factory<_i34.ReportUserBloc>(() => _i34.ReportUserBloc());
    gh.factory<_i35.ResendVerificationCodeBloc>(
        () => _i35.ResendVerificationCodeBloc());
    gh.factory<_i36.SendMessageBloc>(() => _i36.SendMessageBloc());
    gh.factory<_i37.SetUserLocationBloc>(() => _i37.SetUserLocationBloc());
    gh.factory<_i38.SignInBloc>(() => _i38.SignInBloc());
    gh.factory<_i39.SpotifyAuthApi>(
        () => spotifyInjectionModule.spotifyAuthApi(gh<_i14.EnvModel>()));
    gh.factory<_i40.SpotifyAuthUseCase>(
        () => spotifyInjectionModule.spotifyAuthRepository);
    gh.factory<_i41.SpotifyFetchUserInfoApi>(() =>
        spotifyInjectionModule.spotifyFetchUserInfoApi(gh<_i14.EnvModel>()));
    gh.factory<_i42.SpotifyFetchUserInfoUseCase>(
        () => spotifyInjectionModule.spotifyFetchUserInfoRepository);
    await gh.singletonAsync<_i43.ThemeModel>(
      () => _i43.ThemeModel.create(),
      preResolve: true,
    );
    gh.lazySingleton<_i44.TokenStorage<_i45.SpotifyAuthModel>>(
        () => _i46.SecureSpotifyAuthStorage(gh<_i21.FlutterSecureStorage>()));
    gh.lazySingleton<_i44.TokenStorage<_i47.AuthModel>>(
        () => _i48.SecureAuthStorage(gh<_i21.FlutterSecureStorage>()));
    gh.lazySingleton<_i44.TokenStorage<_i49.DeviceTokenModel>>(
        () => _i50.SecureDeviceTokenStorage(gh<_i21.FlutterSecureStorage>()));
    gh.factory<_i51.UndoLikeUserBloc>(() => _i51.UndoLikeUserBloc());
    gh.factory<_i52.UniversitiesApi>(
        () => universityInjectionModule.universitiesApi(gh<_i14.EnvModel>()));
    gh.factory<_i53.UnmatchUserBloc>(() => _i53.UnmatchUserBloc());
    gh.factory<_i54.UpdateUserBloc>(() => _i54.UpdateUserBloc());
    gh.factory<_i55.UploadPhotoBloc>(() => _i55.UploadPhotoBloc());
    gh.factory<_i56.ValidatePhoneBloc>(() => _i56.ValidatePhoneBloc());
    gh.factory<_i57.VerifyPhotoUserBloc>(() => _i57.VerifyPhotoUserBloc());
    gh.factory<_i58.Dio>(() => dioInjection.dio(gh<_i14.EnvModel>()));
    return this;
  }
}

class _$RouterInjection extends _i59.RouterInjection {}

class _$SecureStorageInjection extends _i60.SecureStorageInjection {}

class _$UniversityInjectionModule extends _i61.UniversityInjectionModule {}

class _$GraphQLInjection extends _i62.GraphQLInjection {}

class _$NetworkInfoInjection extends _i63.NetworkInfoInjection {}

class _$SpotifyInjectionModule extends _i64.SpotifyInjectionModule {}

class _$DioInjection extends _i65.DioInjection {}
