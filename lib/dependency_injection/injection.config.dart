...
import 'package:fresh_dio/fresh_dio.dart' as _i26;
...
import 'package:senpai/core/auth/blocs/resend_verification_code_bloc.dart'
    as _i21;
import 'package:senpai/core/auth/blocs/sign_in_bloc.dart' as _i24;
import 'package:senpai/core/auth/blocs/validate_phone_bloc.dart' as _i32;
import 'package:senpai/core/chat/blocs/send_message_bloc.dart' as _i22;
...
import 'package:senpai/core/profile_fill/api/universities_api.dart' as _i29;
...
import 'package:senpai/core/profile_fill/set_user_location/set_user_location_bloc.dart'
    as _i23;
import 'package:senpai/core/secure_storage/secure_auth_storage.dart' as _i28;
...
import 'package:senpai/core/user/blocs/verify_photo_user/verify_photo_user_bloc.dart'
    as _i33;
import 'package:senpai/dependency_injection/dio_client_di.dart' as _i40;
import 'package:senpai/dependency_injection/graphql_client_di.dart' as _i38;
import 'package:senpai/dependency_injection/network_info_di.dart' as _i39;
import 'package:senpai/dependency_injection/router_di.dart' as _i35;
import 'package:senpai/dependency_injection/secure_storage_di.dart' as _i36;
import 'package:senpai/dependency_injection/university_module_di.dart' as _i37;
import 'package:senpai/domain/profile_fill/universities_usecase.dart' as _i14;
import 'package:senpai/models/auth/auth_model.dart' as _i27;
import 'package:senpai/models/env_model.dart' as _i8;
import 'package:senpai/models/theme_model.dart' as _i25;
...
// initializes the registration of main-scope dependencies inside of GetIt
  Future<_i1.GetIt> init({
    ...
    gh.factory<_i22.SendMessageBloc>(() => _i22.SendMessageBloc());
    gh.factory<_i23.SetUserLocationBloc>(() => _i23.SetUserLocationBloc());
    gh.factory<_i24.SignInBloc>(() => _i24.SignInBloc());
    await gh.singletonAsync<_i25.ThemeModel>(
      () => _i25.ThemeModel.create(),
      preResolve: true,
    );
    gh.lazySingleton<_i26.TokenStorage<_i27.AuthModel>>(
        () => _i28.SecureAuthStorage(gh<_i12.FlutterSecureStorage>()));
    gh.factory<_i29.UniversitiesApi>(
        () => universityInjectionModule.universitiesApi(gh<_i8.EnvModel>()));
    gh.factory<_i30.UpdateUserBloc>(() => _i30.UpdateUserBloc());
    gh.factory<_i31.UploadPhotoBloc>(() => _i31.UploadPhotoBloc());
    gh.factory<_i32.ValidatePhoneBloc>(() => _i32.ValidatePhoneBloc());
    gh.factory<_i33.VerifyPhotoUserBloc>(() => _i33.VerifyPhotoUserBloc());
    gh.factory<_i34.Dio>(() => dioInjection.dio(gh<_i8.EnvModel>()));
    return this;
  }
}

class _$RouterInjection extends _i35.RouterInjection {}

class _$SecureStorageInjection extends _i36.SecureStorageInjection {}

class _$UniversityInjectionModule extends _i37.UniversityInjectionModule {}

class _$GraphQLInjection extends _i38.GraphQLInjection {}

class _$NetworkInfoInjection extends _i39.NetworkInfoInjection {}

class _$DioInjection extends _i40.DioInjection {}
