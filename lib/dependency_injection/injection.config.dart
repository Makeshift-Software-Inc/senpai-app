...
import 'package:fresh_dio/fresh_dio.dart' as _i11;
...
import 'package:senpai/dependency_injection/network_info_di.dart' as _i18;
import 'package:senpai/dependency_injection/router_di.dart' as _i15;
import 'package:senpai/dependency_injection/secure_storage_di.dart' as _i16;
import 'package:senpai/models/auth/auth_model.dart' as _i12;
...
// initializes the registration of main-scope dependencies inside of GetIt
  Future<_i1.GetIt> init({
    ...
    await gh.singletonAsync<_i10.ThemeModel>(
      () => _i10.ThemeModel.create(),
      preResolve: true,
    );
    gh.lazySingleton<_i11.TokenStorage<_i12.AuthModel>>(
        () => _i13.SecureAuthStorage(gh<_i6.FlutterSecureStorage>()));
    gh.factory<_i14.Dio>(() => dioInjection.dio(gh<_i5.EnvModel>()));
    return this;
  }
}

class _$RouterInjection extends _i15.RouterInjection {}

class _$SecureStorageInjection extends _i16.SecureStorageInjection {}

class _$GraphQLInjection extends _i17.GraphQLInjection {}

class _$NetworkInfoInjection extends _i18.NetworkInfoInjection {}
