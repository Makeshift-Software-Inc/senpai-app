...
import 'package:fresh_dio/fresh_dio.dart' as _i22;
...
import 'package:senpai/core/auth/blocs/resend_verification_code_bloc.dart'
    as _i18;
import 'package:senpai/core/auth/blocs/sign_in_bloc.dart' as _i20;
import 'package:senpai/core/auth/blocs/validate_phone_bloc.dart' as _i28;
import 'package:senpai/core/feed/blocs/get_distance_between_users_bloc.dart'
    as _i12;
import 'package:senpai/core/profile_fill/api/universities_api.dart' as _i25;
...
import 'package:senpai/core/profile_fill/set_user_location/set_user_location_bloc.dart'
    as _i19;
import 'package:senpai/core/secure_storage/secure_auth_storage.dart' as _i24;
...
import 'package:senpai/core/user/blocs/verify_photo_user/verify_photo_user_bloc.dart'
    as _i29;
import 'package:senpai/dependency_injection/dio_client_di.dart' as _i36;
import 'package:senpai/dependency_injection/graphql_client_di.dart' as _i34;
import 'package:senpai/dependency_injection/network_info_di.dart' as _i35;
import 'package:senpai/dependency_injection/router_di.dart' as _i31;
import 'package:senpai/dependency_injection/secure_storage_di.dart' as _i32;
import 'package:senpai/dependency_injection/university_module_di.dart' as _i33;
import 'package:senpai/domain/profile_fill/universities_usecase.dart' as _i13;
import 'package:senpai/models/auth/auth_model.dart' as _i23;
import 'package:senpai/models/env_model.dart' as _i8;
import 'package:senpai/models/theme_model.dart' as _i21;
import 'package:senpai/routes/app_router.dart' as _i4;
import 'package:senpai/utils/helpers/logging_helpers.dart' as _i16;
...
// initializes the registration of main-scope dependencies inside of GetIt
  Future<_i1.GetIt> init({
    ...
    gh.factory<_i15.InternetConnection>(() => networkInfoInjection.networkInfo);
    gh.singleton<_i16.LoggingHelper>(_i16.LoggingHelper());
    gh.factory<_i17.ReorderPhotosBloc>(() => _i17.ReorderPhotosBloc());
    gh.factory<_i18.ResendVerificationCodeBloc>(
        () => _i18.ResendVerificationCodeBloc());
    gh.factory<_i19.SetUserLocationBloc>(() => _i19.SetUserLocationBloc());
    gh.factory<_i20.SignInBloc>(() => _i20.SignInBloc());
    await gh.singletonAsync<_i21.ThemeModel>(
      () => _i21.ThemeModel.create(),
      preResolve: true,
    );
    gh.lazySingleton<_i22.TokenStorage<_i23.AuthModel>>(
        () => _i24.SecureAuthStorage(gh<_i11.FlutterSecureStorage>()));
    gh.factory<_i25.UniversitiesApi>(
        () => universityInjectionModule.universitiesApi(gh<_i8.EnvModel>()));
    gh.factory<_i26.UpdateUserBloc>(() => _i26.UpdateUserBloc());
    gh.factory<_i27.UploadPhotoBloc>(() => _i27.UploadPhotoBloc());
    gh.factory<_i28.ValidatePhoneBloc>(() => _i28.ValidatePhoneBloc());
    gh.factory<_i29.VerifyPhotoUserBloc>(() => _i29.VerifyPhotoUserBloc());
    gh.factory<_i30.Dio>(() => dioInjection.dio(gh<_i8.EnvModel>()));
    return this;
  }
}

class _$RouterInjection extends _i31.RouterInjection {}

class _$SecureStorageInjection extends _i32.SecureStorageInjection {}

class _$UniversityInjectionModule extends _i33.UniversityInjectionModule {}

class _$GraphQLInjection extends _i34.GraphQLInjection {}

class _$NetworkInfoInjection extends _i35.NetworkInfoInjection {}

class _$DioInjection extends _i36.DioInjection {}
