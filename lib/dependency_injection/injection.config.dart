...
import 'package:fresh_dio/fresh_dio.dart' as _i36;
...
import 'package:senpai/core/auth/blocs/resend_verification_code_bloc.dart'
    as _i27;
import 'package:senpai/core/auth/blocs/sign_in_bloc.dart' as _i30;
import 'package:senpai/core/auth/blocs/validate_phone_bloc.dart' as _i46;
import 'package:senpai/core/chat/blocs/send_message_bloc.dart' as _i28;
...
import 'package:senpai/core/feed/blocs/undo_like_user_bloc.dart' as _i41;
...
import 'package:senpai/core/profile_fill/api/spotify/spotify_profile_info_api.dart'
    as _i33;
import 'package:senpai/core/profile_fill/api/universities_api.dart' as _i42;
...
import 'package:senpai/core/user/blocs/report_user/report_user_bloc.dart'
    as _i26;
import 'package:senpai/core/user/blocs/unmatch_user/unmatch_bloc.dart' as _i43;
...
import 'package:senpai/core/user/blocs/verify_request_user/fetch_verify_requests.dart'
    as _i16;
import 'package:senpai/dependency_injection/dio_client_di.dart' as _i55;
import 'package:senpai/dependency_injection/graphql_client_di.dart' as _i52;
import 'package:senpai/dependency_injection/network_info_di.dart' as _i53;
import 'package:senpai/dependency_injection/router_di.dart' as _i49;
import 'package:senpai/dependency_injection/secure_storage_di.dart' as _i50;
import 'package:senpai/dependency_injection/spotify_module_di.dart' as _i54;
import 'package:senpai/dependency_injection/university_module_di.dart' as _i51;
...
import 'package:senpai/models/spotify_auth/spotify_auth_model.dart' as _i37;
import 'package:senpai/models/theme_model.dart' as _i35;
...
// initializes the registration of main-scope dependencies inside of GetIt
  Future<_i1.GetIt> init({
    ...
    gh.factory<_i6.ApplicationLocaleBloc>(() => _i6.ApplicationLocaleBloc());
    ...
    gh.factory<_i25.ReorderPhotosBloc>(() => _i25.ReorderPhotosBloc());
    gh.factory<_i26.ReportUserBloc>(() => _i26.ReportUserBloc());
    gh.factory<_i27.ResendVerificationCodeBloc>(
        () => _i27.ResendVerificationCodeBloc());
    gh.factory<_i28.SendMessageBloc>(() => _i28.SendMessageBloc());
    gh.factory<_i29.SetUserLocationBloc>(() => _i29.SetUserLocationBloc());
    gh.factory<_i30.SignInBloc>(() => _i30.SignInBloc());
    gh.factory<_i31.SpotifyAuthApi>(
        () => spotifyInjectionModule.spotifyAuthApi(gh<_i12.EnvModel>()));
    gh.factory<_i32.SpotifyAuthUseCase>(
        () => spotifyInjectionModule.spotifyAuthRepository);
    gh.factory<_i33.SpotifyFetchUserInfoApi>(() =>
        spotifyInjectionModule.spotifyFetchUserInfoApi(gh<_i12.EnvModel>()));
    gh.factory<_i34.SpotifyFetchUserInfoUseCase>(
        () => spotifyInjectionModule.spotifyFetchUserInfoRepository);
    await gh.singletonAsync<_i35.ThemeModel>(
      () => _i35.ThemeModel.create(),
      preResolve: true,
    );
    gh.lazySingleton<_i36.TokenStorage<_i37.SpotifyAuthModel>>(
        () => _i38.SecureSpotifyAuthStorage(gh<_i17.FlutterSecureStorage>()));
    gh.lazySingleton<_i36.TokenStorage<_i39.AuthModel>>(
        () => _i40.SecureAuthStorage(gh<_i17.FlutterSecureStorage>()));
    gh.factory<_i41.UndoLikeUserBloc>(() => _i41.UndoLikeUserBloc());
    gh.factory<_i42.UniversitiesApi>(
        () => universityInjectionModule.universitiesApi(gh<_i12.EnvModel>()));
    gh.factory<_i43.UnmatchUserBloc>(() => _i43.UnmatchUserBloc());
    gh.factory<_i44.UpdateUserBloc>(() => _i44.UpdateUserBloc());
    gh.factory<_i45.UploadPhotoBloc>(() => _i45.UploadPhotoBloc());
    gh.factory<_i46.ValidatePhoneBloc>(() => _i46.ValidatePhoneBloc());
    gh.factory<_i47.VerifyPhotoUserBloc>(() => _i47.VerifyPhotoUserBloc());
    gh.factory<_i48.Dio>(() => dioInjection.dio(gh<_i12.EnvModel>()));
    return this;
  }
}

class _$RouterInjection extends _i49.RouterInjection {}

class _$SecureStorageInjection extends _i50.SecureStorageInjection {}

class _$UniversityInjectionModule extends _i51.UniversityInjectionModule {}

class _$GraphQLInjection extends _i52.GraphQLInjection {}

class _$NetworkInfoInjection extends _i53.NetworkInfoInjection {}

class _$SpotifyInjectionModule extends _i54.SpotifyInjectionModule {}

class _$DioInjection extends _i55.DioInjection {}
