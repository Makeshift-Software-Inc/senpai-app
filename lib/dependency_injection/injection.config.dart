...
import 'package:fresh_dio/fresh_dio.dart' as _i30;
...
import 'package:senpai/core/auth/blocs/validate_phone_bloc.dart' as _i38;
...
import 'package:senpai/core/profile_fill/api/universities_api.dart' as _i35;
...
import 'package:senpai/core/profile_fill/set_user_location/set_user_location_bloc.dart'
    as _i27;
import 'package:senpai/core/secure_storage/secure_auth_storage.dart' as _i34;
...
import 'package:senpai/core/user/blocs/verify_request_user/fetch_verify_requests.dart'
    as _i15;
import 'package:senpai/dependency_injection/dio_client_di.dart' as _i46;
import 'package:senpai/dependency_injection/graphql_client_di.dart' as _i44;
import 'package:senpai/dependency_injection/network_info_di.dart' as _i45;
import 'package:senpai/dependency_injection/router_di.dart' as _i41;
import 'package:senpai/dependency_injection/secure_storage_di.dart' as _i42;
import 'package:senpai/dependency_injection/university_module_di.dart' as _i43;
import 'package:senpai/domain/profile_fill/universities_usecase.dart' as _i18;
import 'package:senpai/models/auth/auth_model.dart' as _i33;
import 'package:senpai/models/env_model.dart' as _i11;
import 'package:senpai/models/spotify_auth/spotify_auth_model.dart' as _i31;
import 'package:senpai/models/theme_model.dart' as _i29;
...
// initializes the registration of main-scope dependencies inside of GetIt
  Future<_i1.GetIt> init({
    ...
    await gh.singletonAsync<_i29.ThemeModel>(
      () => _i29.ThemeModel.create(),
      preResolve: true,
    );
    gh.lazySingleton<_i30.TokenStorage<_i31.SpotifyAuthModel>>(
        () => _i32.SecureSpotifyAuthStorage(gh<_i16.FlutterSecureStorage>()));
    gh.lazySingleton<_i30.TokenStorage<_i33.AuthModel>>(
        () => _i34.SecureAuthStorage(gh<_i16.FlutterSecureStorage>()));
    gh.factory<_i35.UniversitiesApi>(
        () => universityInjectionModule.universitiesApi(gh<_i11.EnvModel>()));
    gh.factory<_i36.UpdateUserBloc>(() => _i36.UpdateUserBloc());
    gh.factory<_i37.UploadPhotoBloc>(() => _i37.UploadPhotoBloc());
    gh.factory<_i38.ValidatePhoneBloc>(() => _i38.ValidatePhoneBloc());
    gh.factory<_i39.VerifyPhotoUserBloc>(() => _i39.VerifyPhotoUserBloc());
    gh.factory<_i40.Dio>(() => dioInjection.dio(gh<_i11.EnvModel>()));
    return this;
  }
}

class _$RouterInjection extends _i41.RouterInjection {}

class _$SecureStorageInjection extends _i42.SecureStorageInjection {}

class _$UniversityInjectionModule extends _i43.UniversityInjectionModule {}

class _$GraphQLInjection extends _i44.GraphQLInjection {}

class _$NetworkInfoInjection extends _i45.NetworkInfoInjection {}

class _$DioInjection extends _i46.DioInjection {}
