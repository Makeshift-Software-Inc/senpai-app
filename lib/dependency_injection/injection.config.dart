...
import 'package:senpai/core/events/blocs/fetch_events/fetch_events_bloc.dart'
    as _i18;
import 'package:senpai/core/feed/blocs/fetch_feed_bloc.dart' as _i19;
...
// initializes the registration of main-scope dependencies inside of GetIt
  Future<_i1.GetIt> init({
    ...
    gh.factory<_i18.FetchEventsBloc>(() => _i18.FetchEventsBloc());
    gh.factory<_i19.FetchFeedBloc>(() => _i19.FetchFeedBloc());
    ...
    gh.lazySingleton<_i43.TokenStorage<_i44.AuthModel>>(
        () => _i45.SecureAuthStorage(gh<_i22.FlutterSecureStorage>()));
    gh.lazySingleton<_i43.TokenStorage<_i46.DeviceTokenModel>>(
        () => _i47.SecureDeviceTokenStorage(gh<_i22.FlutterSecureStorage>()));
    gh.lazySingleton<_i43.TokenStorage<_i48.SpotifyAuthModel>>(
        () => _i49.SecureSpotifyAuthStorage(gh<_i22.FlutterSecureStorage>()));
    ...
    gh.factory<_i57.Dio>(() => dioInjection.dio(gh<_i15.EnvModel>()));
    return this;
  }
}
