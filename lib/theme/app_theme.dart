...
import 'package:senpai/theme/color/app_color_scheme.dart';
import 'package:senpai/theme/text/app_text_theme.dart';
import 'package:senpai/theme/text/app_typography.dart';
...
Future<ThemeData> createTheme({
  ...
  final appTypography = AppTypography.create(
    ...
    secondaryFontFamily: $constants.theme.secondaryFontFamily,
    tertiaryFontFamily: $constants.theme.tertiaryFontFamily,
  );
  final textTheme =
